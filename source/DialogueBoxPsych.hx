...
class DialogueBoxPsych extends FlxSpriteGroup
{
	...
	public function new(dialogueList:DialogueFile, song:String = "homeBop")
	{
		super();
	...
	function startNextDialog():Void
	{
		...
		if (char.curCharacter.toString() == "redacted")
			daText.hasDialogueSounds = false;
		else
		{
			daText.hasDialogueSounds = true;
			daText.dialogueSoundName = char.curCharacter.toString().toLowerCase() + "Dialogue";
		}
		if (char != null)
		{
		...
		switch (curDialogue.mod)
		{
			case "PULSESHADER":
				PlayState.forceShadersOn = !PlayState.forceShadersOn;
