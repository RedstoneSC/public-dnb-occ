...
class DialogueEditorState extends MusicBeatState
{
	...
	function addDialogueLineUI()
	{
		...
		modDropDown = new FlxUIDropDownMenuCustom(-50, 50, FlxUIDropDownMenuCustom.makeStrIdLabelArray(["NONE", "PULSE"], true), function(pressed:String)
		{
			var newMod:String = "NONE";
			...
			dialogueFile.dialogue[curSelected].mod = newMod;
		});
